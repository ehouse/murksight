      ...
      <div className='columns'>
        <div className='column col-3 pt-2'>
          ...
          <div className='verticle-btn-grp method-picker'>
            ...
            <button className={`btn ${getButtonState('method', 'passphrase')}`} onClick={() => dispatch({ type: 'method', payload: 'passphrase' })}>Pass Phrase</button>
          ...
          <div className='length-picker'>
            ...
            <div className="btn-group btn-group-block">
              <button className={`btn ${getButtonState('length', 'short')}`} onClick={() => dispatch({ type: 'length', payload: 'short' })}>short</button>
